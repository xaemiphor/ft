...
class SimpleKCOuter(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(qtpylib.crossed_below(dataframe["tema"], dataframe["kc_lowerband"]))
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for x in range(10):
            conditions.append(dataframe["volume"].shift(x) > 0)
        conditions.append(qtpylib.crossed_above(dataframe["tema"], dataframe["kc_upperband"]))
